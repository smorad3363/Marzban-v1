...
NODE_OPERATIONS_EVENT_RETENTION_DAYS = max(
    1, config("NODE_OPERATIONS_EVENT_RETENTION_DAYS", cast=int, default=30)
)
NODE_OPERATIONS_TRAFFIC_RETENTION_DAYS = max(
    1, config("NODE_OPERATIONS_TRAFFIC_RETENTION_DAYS", cast=int, default=7)
)
NODE_OPERATIONS_RETENTION_BATCH_SIZE = max(
    1, min(config("NODE_OPERATIONS_RETENTION_BATCH_SIZE", cast=int, default=5000), 10000)
)
...
JOB_NODE_OPERATIONS_RETENTION_INTERVAL = max(
    300,
    config("JOB_NODE_OPERATIONS_RETENTION_INTERVAL", cast=int, default=3600),
)
